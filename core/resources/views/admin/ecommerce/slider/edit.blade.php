                    ...
                    <div class="card card-primary card-outline">
                            <div class="card-header">
                                ...
                                <div class="card-tools">
                                    <a href="{{ route('admin.ecommerce.slider'). '?language=' . $currentLang->code }}" class="btn btn-primary btn-sm">
                            ...
                            <!-- /.card-header -->
                            <div class="card-body">
                                <form class="form-horizontal" action="{{ route('admin.ecommerce.sliderUpdate',  $slider->id) }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="form-group row">
                                        <label class="col-sm-2 control-label">{{ __('Background Image') }}<span class="text-danger">*</span></label>
        
                                        <div class="col-sm-10">
                                            <img class="mw-400 mb-3 img-demo show-img" src="{{ asset('assets/front/img/slider/'.$slider->background_image) }}" alt="">
                                            <div class="custom-file">
                                                <label class="custom-file-label" for="background_image">{{ __('Choose New Image') }}</label>
                                                <input type="file" class="custom-file-input up-img" name="background_image" id="background_image">
                                            </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="price" placeholder="{{ __('Price') }}" value="{{ $slider->price }}">
                                            @if ($errors->has('price'))
